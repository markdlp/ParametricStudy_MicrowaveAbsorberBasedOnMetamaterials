\section{\textsf{Simulation}}
    ...
    \subsection{\textsf{CST Implementation}}
        ...
        \begin{figure}[h]
            \centering
            \includegraphics[width=0.4\textwidth]{faceCenterPoint.png}
        ...
        The \epsilon and \mu are being extracted from the $S_{11}$ and $S_{12}$ parameters.
