    ...
    \subsection{\textsf{Alternative Modeling Methods}}
        ...
        \begin{center}
            ...
            \begin{minipage}{.45\textwidth}
                \begin{tikzpicture}
                    \begin{axis}[ 
                        title={\textsf{Effective Permittivity \& Permeability}},
                        xlabel={Frequency (GHz)}, ylabel={$\epsilon_{eff} \& \mu_{eff}$},
                        legend pos=north east 
                    ]   
                        \addplot table[x=freq, y=epsilon_eff, col sep=tab] {data/epsilon_eff.txt};
                        \addplot table[x=freq, y=mu_eff, col sep=tab] {data/mu_eff.txt};
            ...
            \begin{minipage}{.45\textwidth}
                \begin{tikzpicture}
                    \begin{axis}[ 
                        ...
                        xlabel={Frequency (GHz)}, ylabel={$\exp{-j\kappa z}$},
                        legend pos=north east 
                    ] 
                        ...
                        \addlegendentry{\Re{($\exp{-j\kappa z}$)}}
                        \addlegendentry{\Im{($\exp{-j\kappa z}$)}}
                    \end{axis}
                \end{tikzpicture}
                % \caption{\textsf{\Re{($z$)}}}
                \label{plt:exp}
