\section{\textsf{Simulation}} 
    ...
    \subsection{\textsf{CST Implementation}} 
        ...
        a conductivity of ($5.96 \mu 10^7 \frac{S}{m}$).
    ...
    \subsection{\textsf{Evaluation}}
        ...
        %     \centering
        %     \begin{tabular}{ccc}
        %         \animategraphics[width=0.31\textwidth, timeline=timeline.txt]{4}{img/E_Zmax1_027e2MHz/E_Zmax1_027e2MHz-}{0}{89}&
        %         \animategraphics[width=0.31\textwidth, timeline=timeline.txt]{4}{img/E_Zmax1_077e2MHz/E_Zmax1_077e2MHz-}{0}{89}&
        %         \animategraphics[width=0.31\textwidth, timeline=timeline.txt]{4}{img/E_Zmax1_127e2MHz/E_Zmax1_127e2MHz-}{0}{89}\\
        %         \animategraphics[width=0.31\textwidth, timeline=timeline.txt]{4}{img/E_Zmax2_027e2MHz/E_Zmax2_027e2MHz-}{0}{89}&
        %         \animategraphics[width=0.31\textwidth, timeline=timeline.txt]{4}{img/E_Zmax2_077e2MHz/E_Zmax2_077e2MHz-}{0}{89}&
        %         \animategraphics[width=0.31\textwidth, timeline=timeline.txt]{4}{img/E_Zmax2_127e2MHz/E_Zmax2_127e2MHz-}{0}{89}\\
        %     \end{tabular}
        %     \caption{Electrical Field for [2.7, 7.7, 12.7] GHz $Z_{max}$}
        %     \label{img:E}
        % \end{figure}
